...
from samurai_ide.dependencies import pycodestyle
from samurai_ide.gui.editor.checkers import register_checker
from samurai_ide.gui.editor.checkers import remove_checker
