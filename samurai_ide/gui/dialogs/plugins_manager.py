...
from samurai_ide.core import plugin_manager
...
logger = NinjaLogger('samurai_ide.gui.dialogs.plugin_manager')
...
class PluginsManagerWidget(QDialog):
    ...
    def _open_link(self, url):
        ...
        if link.startswith('/plugins/'):
            link = 'http://samurai-ide.org' + link
...
class ThreadLoadPlugins(QThread):
    ...
    def collect_data_thread(self):
        """
        Collects plugins info from Samurai-IDE webservice interface
        """
